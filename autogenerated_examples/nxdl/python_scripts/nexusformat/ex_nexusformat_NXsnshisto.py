...
root['/entry/definition'] = NXfield('NXsnshisto')
...
root['/entry/instrument/detector/data_x_time_of_flight'] = NXfield(1)
...
root['/entry/instrument/detector/data_y_time_of_flight'] = NXfield(1)
...
root['/entry/instrument/NXfermi_chopper/distance'] = NXfield(1.0)
...
# Create the LINKS 
root['/entry/data/data_x_time_of_flight'] = NXlink(target='/entry/instrument/detector/data_x_time_of_flight')

# Create the LINKS 
root['/entry/data/data_x_y'] = NXlink(target='/entry/instrument/detector/data_x_y')

# Create the LINKS 
root['/entry/data/data_y_time_of_flight'] = NXlink(target='/entry/instrument/detector/data_y_time_of_flight')

# Create the LINKS 
root['/entry/data/pixel_id'] = NXlink(target='/entry/instrument/detector/pixel_id')

# Create the LINKS 
root['/entry/data/time_of_flight'] = NXlink(target='/entry/instrument/detector/time_of_flight')

# Create the LINKS 
root['/entry/data/total_counts'] = NXlink(target='/entry/instrument/detector/total_counts')
