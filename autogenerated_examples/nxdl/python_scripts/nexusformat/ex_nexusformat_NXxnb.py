...
root['/entry/start_time'] = NXfield('2021-03-26T13:08:01.724187')
...
root['/entry/instrument/detector/tilt_angle'] = NXfield(1.0)
...
root['/entry/name/tilt'] = NXlink(target='/entry/title')
...
root.save('nexusformat_NXxnb.h5', 'w')
