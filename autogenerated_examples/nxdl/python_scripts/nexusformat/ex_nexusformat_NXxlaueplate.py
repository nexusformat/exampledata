...
root['/entry/instrument/source/distribution'] = NXdata()
...
root['/entry/start_time'] = NXfield('2021-03-26T13:08:01.232175')
...
root['/entry/instrument/source/distribution/data'] = NXfield('SAMPLE-CHAR-DATA')
...
root['/entry/instrument/source/distribution/wavelength'] = NXfield('SAMPLE-CHAR-DATA')
...
root['/entry/instrument/detector/diameter'] = NXfield(1.0)
...
root.save('nexusformat_NXxlaueplate.h5', 'w')
