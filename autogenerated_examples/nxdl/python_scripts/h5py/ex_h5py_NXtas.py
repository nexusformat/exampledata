...
root['/entry'].create_dataset(name='start_time', data='2021-03-26T13:07:56.095933', maxshape=None)
...
root['/entry/data/ef'] = h5py.SoftLink('/entry/instrument/analyser/ef')
root['/entry/data/ef/'].attrs['target'] = '/entry/instrument/analyser/ef'
