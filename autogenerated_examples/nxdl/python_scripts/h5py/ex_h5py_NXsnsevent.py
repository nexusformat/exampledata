...
root = h5py.File('NXsnsevent.h5', 'w')
...
root['/entry/'].create_group('NXevent_data')
root['/entry/NXevent_data'].attrs['NX_class'] = 'NXevent_data'
...
root['/entry'].create_dataset(name='definition', data='NXsnsevent', maxshape=None)
...
root['/entry/instrument/detector'].create_dataset(name='event_index', data=np.ushort(1), maxshape=None)
...
root['/entry/instrument/detector'].create_dataset(name='event_pixel_id', data=np.ushort(1), maxshape=None)
...
root['/entry/instrument/detector'].create_dataset(name='event_time_of_flight', data=1.0, maxshape=None)
...
root['/entry/instrument/detector'].create_dataset(name='pulse_time', data=1.0, maxshape=None)
...
# Create the LINKS 
root['/entry/NXevent_data/event_index'] = h5py.SoftLink('/entry/instrument/detector/event_index')
root['/entry/NXevent_data/event_index/'].attrs['target'] = '/entry/instrument/detector/event_index'

# Create the LINKS 
root['/entry/NXevent_data/event_pixel_id'] = h5py.SoftLink('/entry/instrument/detector/event_pixel_id')
root['/entry/NXevent_data/event_pixel_id/'].attrs['target'] = '/entry/instrument/detector/event_pixel_id'

# Create the LINKS 
root['/entry/NXevent_data/event_time_of_flight'] = h5py.SoftLink('/entry/instrument/detector/event_time_of_flight')
root['/entry/NXevent_data/event_time_of_flight/'].attrs['target'] = '/entry/instrument/detector/event_time_of_flight'

# Create the LINKS 
root['/entry/NXevent_data/pulse_time'] = h5py.SoftLink('/entry/instrument/detector/pulse_time')
root['/entry/NXevent_data/pulse_time/'].attrs['target'] = '/entry/instrument/detector/pulse_time'
...
root.attrs['file_name'] = os.path.abspath('NXsnsevent')
