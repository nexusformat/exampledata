...
root['/entry'].create_dataset(name='start_time', data='2021-03-26T13:07:54.537225', maxshape=None)
...
root['/entry'].create_dataset(name='definition', data='NXsastof', maxshape=None)
