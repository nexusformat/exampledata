...
root['/entry/process'].create_dataset(name='date', data='2022-03-04T14:56:33.595457', maxshape=None)
...
root['/entry/data/ShadowFactor'].attrs['EX_doc'] = 'NCNR instruments. See: J.G. Barker and J.S. Pedersen (1995) *J. Appl. Cryst.* **28**, 105-114. '
...
root['/entry/instrument/collimator/length'].attrs['EX_doc'] = 'length of collimation inserted (as on a SANS instrument) '
...
root['/entry/sample/transmission'].attrs['EX_doc'] = 'I_0`) of this sample. There is no *units* attribute as this number is dimensionless. Note: the ability to store a transmission *spectrum*, instead of a single value, is provided elsewhere in the structure, in the *SAStransmission_spectrum* element. '
...
root['/entry/TRANSMISSION_SPECTRUM/T'].attrs['EX_doc'] = 'I_0`) as a function of wavelength. This array is of the same shape as ``lambda`` and ``Tdev``. '
root['/entry/TRANSMISSION_SPECTRUM/Tdev'].attrs['EX_doc'] = '@uncertainties="Tdev" This array is of the same shape as ``lambda`` and ``T``. '
...
#	 1/nm
#	 1/angstrom
root['/entry/data/Q'].attrs['units'] = 'm'
...
#	 cm2/g
#	 arbitrary
root['/entry/data/I'].attrs['units'] = 'm'
