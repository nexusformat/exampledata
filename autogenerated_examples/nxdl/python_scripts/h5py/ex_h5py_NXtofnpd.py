...
root = h5py.File('h5py_NXtofnpd.h5', 'w')
...
root['/entry'].create_dataset(name='start_time', data='2021-03-22T14:00:28.444914', maxshape=None)
...
root['/entry'].create_dataset(name='definition', data='NXtofnpd', maxshape=None)
...
root['/entry/untitled_instrument/detector/data'].attrs['units'] = ''
...
root['/entry/untitled_instrument/detector'].create_dataset(name='detector_number', data=[1], maxshape=None)
root['/entry/untitled_instrument/detector/detector_number'].attrs['type'] = 'NX_INT'
root['/entry/untitled_instrument/detector/detector_number'].attrs['units'] = ''
root['/entry/untitled_instrument/detector/detector_number'].attrs['EX_required'] = 'true'
root['/entry/untitled_instrument/detector/detector_number'].attrs['axis'] = '2'
...
root['/entry/untitled_instrument/detector/distance'].attrs['units'] = ''
...
root['/entry/untitled_instrument/detector/time_of_flight'].attrs['units'] = ''
...
root['/entry/untitled_instrument/detector/polar_angle'].attrs['units'] = ''
...
root['/entry/untitled_instrument/detector/azimuthal_angle'].attrs['units'] = ''
...
root['/entry/untitled_instrument/detector/distance'].attrs['EX_doc'] = '       distance to sample for each detector      '
