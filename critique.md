...
date: 2020-01-21 18:47:40.795721
...
``simple3D.h5``             | NeXus HDF5 file
``verysimple.xml``          | not HDF5 file  
``writer_1_3.h5``           | NeXus HDF5 file
...
file                  | critique       
--------------------- | ---------------
``PLP0006018.nx.hdf`` | NeXus HDF5 file
...
file                    | critique       
----------------------- | ---------------
``AgBehenate_228.hdf5`` | NeXus HDF5 file
...
file                     | critique       
------------------------ | ---------------
``ID34_not_complete.h5`` | NeXus HDF5 file
...
file                     | critique       
------------------------ | ---------------
``sample_capillary.nxs`` | NeXus HDF5 file
...
file                  | critique       
--------------------- | ---------------
``p45-1168-mic.hdf5`` | NeXus HDF5 file
``p45-1168.nxs``      | NeXus HDF5 file
``p45-2194.nxs``      | NeXus HDF5 file
``p45-316.nxs``       | NeXus HDF5 file
...
file                         | critique       
---------------------------- | ---------------
``thaumatin_integrated.nxs`` | NeXus HDF5 file
...
file           | critique       
-------------- | ---------------
``file_1.nxs`` | NeXus HDF5 file
``file_2.nxs`` | NeXus HDF5 file
...
-------------------------------------- | ---------------
``README``                             | not HDF5 file  
``lyso009a_0087.JF07T32V01_master.h5`` | NeXus HDF5 file
...
------------------------ | ---------------
``NXtest.h5``            | HDF5 file      
``dmc01.h5``             | NeXus HDF5 file
``dmc02.h5``             | NeXus HDF5 file
``focus2007n001335.hdf`` | NeXus HDF5 file
``sans2009n012333.hdf``  | NeXus HDF5 file
