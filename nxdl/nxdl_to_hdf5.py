...
def write_script_files(class_nm):
    ...
    write_script(mod_name,
                 os.path.join(os.getcwd(), '..', 'autogenerated_examples','nxdl', 'python_scripts', mod_name),
                 class_nm,
                 h5py_script_lst)
    mod_name = 'nexusformat'
    write_script(mod_name,
                 os.path.join(mod_name, os.getcwd(), '..', 'autogenerated_examples','nxdl', 'python_scripts', mod_name),
                 class_nm,
                 nxsfrmt_script_lst)
