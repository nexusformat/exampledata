...
as a string attribute for that field or group called EX_doc. 
 ...
 installed, each generated file contains an attribute called disclaimer that says what 
 release version of the application definitions was used to generate the file. If the 
 user updates their application definitions then they should also run nxdl_to_hdf5.py 
...
def _dataset(nxgrp, name, data, nxdata_type, nx_units='NX_ANY', dset={}):
    ...
    _string_attr(grp, 'type', nxdata_type)
...
def add_docs(nf, docs):
    ...
    for d in docs:
        ...
        _string_attr(pgrp, 'EX_doc', d['doc'])
